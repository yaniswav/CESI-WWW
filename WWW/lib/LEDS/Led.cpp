...
Led::Led(byte pin, byte pinData, byte ledNumber) : _pin(pin), _pinData(pinData), _ledNumber(ledNumber)
{
}
...
void Led::errorColor(String firstColor, byte firstTime, String secondColor, byte secondTime)
{
	long actual = millis();
